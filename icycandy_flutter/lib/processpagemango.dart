...
class processmango extends StatelessWidget{
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: new Container(
        ...
        child: new Column(
          children: <Widget>[
            new Image(image: new AssetImage('asset/ic5.jpg'),height: 350.0,width: 3450.0,matchTextDirection: true,),
            new Text("Mango",textAlign: TextAlign.center,textScaleFactor: 3.0,style: new TextStyle(fontFamily: 'Skranji'),),
