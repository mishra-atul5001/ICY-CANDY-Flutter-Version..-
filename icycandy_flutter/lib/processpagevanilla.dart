...
class processvanilla extends StatelessWidget{
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: new Container(
        ...
        child: new Column(
          children: <Widget>[
            new Image(image: new AssetImage('asset/ic6.jpg'),height: 400.0,width: 3450.0,matchTextDirection: true,),
            new Text("Vanilla",textAlign: TextAlign.center,textScaleFactor: 3.0,style: new TextStyle(fontFamily: 'Skranji'),),
